...
typedef FT_Bool (*FT_CMap_CharVarIsDefaultFunc)(FT_CMap cmap,
                                                FT_UInt32 char_code,
                                                FT_UInt32 variant_selector);
...
/*                                                                       */
typedef FT_Error (*FT_Module_Creator)(FT_Memory memory,
                                      FT_Module_Class **output_class);
...
/*                                                                       */
typedef void (*FT_Module_Destroyer)(FT_Memory memory,
                                    FT_Module_Class *clazz);
