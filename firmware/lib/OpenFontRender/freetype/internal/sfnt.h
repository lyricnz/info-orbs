...
/*                                                                       */
typedef FT_Error (*TT_Set_SBit_Strike_OldFunc)(TT_Face face,
                                               FT_UInt x_ppem,
                                               FT_UInt y_ppem,
...
/*    released.                                                          */
/*                                                                       */
typedef FT_Error (*TT_CharMap_Load_Func)(TT_Face face,
                                         void *cmap,
                                         FT_Stream input);
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
typedef FT_Error (*TT_CharMap_Free_Func)(TT_Face face,
                                         void *cmap);
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
typedef FT_Error (*TT_Get_Metrics_Func)(TT_Face face,
                                        FT_Bool vertical,
                                        FT_UInt gindex,
                                        FT_Short *abearing,
                                        FT_UShort *aadvance);
